...
> {
  ...
  index: () => Promise<AxiosResponse<Model[], unknown>>;
  show: (id: number) => Promise<AxiosResponse<Model, unknown>>;
  store: (p: ReqStore) => Promise<AxiosResponse<Model, unknown>>;
  update: (id: number, p: ReqUpdate) => Promise<AxiosResponse<Model, unknown>>;
